            ...
            <div class="col-md-8 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-center mb-4"> <i class="fas fa-check-circle" style="color: green;"></i> Vos rendez-vous sont bien confirm� !  </h5>     
                        ...
                        <c:if test="${not empty rendezVousResumeSecond.listRecapInfoRendezVous}">
                            ...
                            <c:forEach var="rendezVous" items="${rendezVousResumeSecond.listRecapInfoRendezVous}">
                                ...
                                <p>Num�ro de dose: <strong>${rendezVous.numeroDose}</strong></p>
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="recevoirEmail">
                                            Je souhaite recevoir un r�sum� de mes rendez-vous par email
                                        </label>
                                    </div>
                                </div>
